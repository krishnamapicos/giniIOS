...
class InteriorsPage: UIViewController,UICollectionViewDataSource, UICollectionViewDelegate {

    @IBOutlet weak var interiorsCvw: UICollectionView!
   ...
   // var productIdArr = NSMutableArray()
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        interiorsCvw.delegate = self
        interiorsCvw.dataSource = self
        
        interiorsCvw.registerNib(UINib(nibName:"FavCollectionCell", bundle: nil), forCellWithReuseIdentifier: "Cell")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell
    {
        ...
        ccell  = interiorsCvw.dequeueReusableCellWithReuseIdentifier("Cell", forIndexPath: indexPath) as! FavCollectionCell
    ...
    func productListAPI(){
        if !(CommonFunctions.reachabiltyCheck()){
            ...
            let url:NSURL = NSURL(string:"http://103.1.172.70/GINI/gini/index.php/REST/Products/product_by_genre_id?genre_id=2")!
    ...
    func goToShopPage(sender: UIButton) {
        ...
        let buttonPosition = sender.convertPoint(CGPointZero, toView: interiorsCvw) as CGPoint
        let indexPath = interiorsCvw.indexPathForItemAtPoint(buttonPosition)! as NSIndexPath
