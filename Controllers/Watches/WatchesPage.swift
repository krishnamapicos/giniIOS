...
class WatchesPage: UIViewController, UICollectionViewDataSource,UICollectionViewDelegate,PBJVideoPlayerControllerDelegate {
    @IBOutlet weak var watchsCvw: UICollectionView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        watchsCvw.delegate = self
        watchsCvw.dataSource = self
        // favCollVw.registerNib(UINib(nibName:"FavCollectionCell", bundle: nil), forCellWithReuseIdentifier: "cellIdentifier")
        watchsCvw.registerNib(UINib(nibName:"FavCollectionCell", bundle: nil), forCellWithReuseIdentifier: "Cell")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell
    {
        ...
        ccell  = watchsCvw.dequeueReusableCellWithReuseIdentifier("Cell", forIndexPath: indexPath) as! FavCollectionCell
    ...
    func productListAPI(){
        if !(CommonFunctions.reachabiltyCheck()){
            ...
            let url:NSURL = NSURL(string:"http://103.1.172.70/GINI/gini/index.php/REST/Products/product_by_genre_id?genre_id=5")!
       ...
       func goToShopPage(sender: UIButton) {
        ...
        let buttonPosition = sender.convertPoint(CGPointZero, toView: watchsCvw) as CGPoint
        let indexPath = watchsCvw.indexPathForItemAtPoint(buttonPosition)! as NSIndexPath
