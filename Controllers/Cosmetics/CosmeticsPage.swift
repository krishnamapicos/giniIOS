...
class CosmeticsPage: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource , PBJVideoPlayerControllerDelegate{

    @IBOutlet weak var cosmTb: UICollectionView!
   ...
   // var productIdArr = NSMutableArray()
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        cosmTb.delegate = self
        cosmTb.dataSource = self
        // favCollVw.registerNib(UINib(nibName:"FavCollectionCell", bundle: nil), forCellWithReuseIdentifier: "cellIdentifier")
        cosmTb.registerNib(UINib(nibName:"FavCollectionCell", bundle: nil), forCellWithReuseIdentifier: "Cell")
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell
    {
        ...
        ccell  = cosmTb.dequeueReusableCellWithReuseIdentifier("Cell", forIndexPath: indexPath) as! FavCollectionCell
    ...
    func collectionView(collectionView: UICollectionView,
      ...
      func productListAPI(){
        if !(CommonFunctions.reachabiltyCheck()){
            ...
            let url:NSURL = NSURL(string:"http://103.1.172.70/GINI/gini/index.php/REST/Products/product_by_genre_id?genre_id=4")!
    ...
    func goToShopPage(sender: UIButton) {
        ...
        let buttonPosition = sender.convertPoint(CGPointZero, toView: cosmTb) as CGPoint
        let indexPath = cosmTb.indexPathForItemAtPoint(buttonPosition)! as NSIndexPath
